...
export default class HeaderUserComponent extends Component {
    constructor(props){
        super(props)
                ...
                <header >
                    ...
                    <nav className="navbar navbar-expand-md navbar-dark  p-3" style={{backgroundColor: "black"}}>
                        ...
                        <ul>
                            ...
                            <Link className={"navbar-brand  mt-n1 me-5 ms-3"  }    to={{pathname: '/user'}}>Home</Link>
                            <Link className={"navbar-brand  mt-n1 me-5 ms-3"  }    to={{pathname: '/'}}>Logout</Link>
